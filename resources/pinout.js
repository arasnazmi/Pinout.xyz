...
const storedTheme=(()=>{try{return window.localStorage.getItem('gemstone-theme')}catch(_){return null}})()
...
themeToggle?.addEventListener('click',()=>{const theme=document.documentElement.dataset.theme==='dark'?'light':'dark'
applyTheme(theme)
...
if(legend?.src.endsWith('.svg')){inlining??=inlineLegend()}})